...
class ModelLogger:
    def __init__(self, output_path, remove_prefix_in_ckpt=None, state_dict_converter=lambda x:x, use_wandb=False):
...
def wan_parser():
    ...
    parser.add_argument("--disable_lora", action="store_true", help="resume path")
    return parser
